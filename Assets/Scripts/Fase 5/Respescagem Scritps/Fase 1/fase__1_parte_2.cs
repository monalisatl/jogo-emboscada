...
{
    public class Fase1Parte2Repescagem : MonoBehaviour
    {
        public static Fase1Parte2Repescagem Instance;
    
        [SerializeField] private ZonaSoltaRepescagem[] dropZones;
        [SerializeField] private Button confirmButton;
        [SerializeField] private Button rejectButton;
        [SerializeField] private GameObject tableButtons;
        public static int acertos_garais = 0;
        [SerializeField] private ArrastavelRepescagem[] allDraggableItems;
        ...
        private void Start()
        {
            ...
            {
                allDraggableItems = FindObjectsByType<ArrastavelRepescagem>(FindObjectsSortMode.None);
            }
        ...
        private void TimeOut()
        {
            ...
            foreach (ZonaSoltaRepescagem zone in dropZones)
            {
                if (!zone) continue;
        ...
        private void DesabilitarArrastaveis()
        {
            ...
            foreach (ArrastavelRepescagem item in allDraggableItems)
            {
                if (item == null) continue;
           
                // Existem várias maneiras de desabilitar o arrasto, dependendo de como o script ArrastavelRepescagem está implementado
                // Opção 1: Desabilitar o componente
                item.enabled = false;
           
                // Opção 2: Se o script ArrastavelRepescagem tem uma propriedade ou método para desabilitar o arrasto, usar isso
