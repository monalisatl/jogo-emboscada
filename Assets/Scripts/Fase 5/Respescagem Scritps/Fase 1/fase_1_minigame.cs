...
{
    public class Fase1RepescagemMinigame : MonoBehaviour
    {
        [Header("Timer")]
        ...
        void Start()
        {
            ...
            // Verificar se todos os botões têm o componente BotaoSelecionavelRepescagem
        ...
        private void VerificarComponentesBotoes()
        {
            ...
            foreach (GameObject botao in todosBotoes)
            {
                ...
                // Verificar se o botão tem o componente BotaoSelecionavelRepescagem
                BotaoSelecionavelRepescagem comp = botao.GetComponent<BotaoSelecionavelRepescagem>();
                if (comp == null)
                {
                    Debug.LogWarning($"O botão {botao.name} não tem o componente BotaoSelecionavelRepescagem! Adicionando...");
                    botao.AddComponent<BotaoSelecionavelRepescagem>();
                }
